          ...
          <div className="row">
              ...
              <div className="projects-detalis__content">
                <div className="projects-detalis__content-carousel owl-carousel owl-theme">
                  <div className="single-img">
                    <img
                      src="/assets/images/resources/projects-detalis-img1.jpg"
                      alt=""
                    />
                  </div>
                  ...
                  <div className="single-img">
                    <img
                      src="/assets/images/resources/projects-detalis-img2.jpg"
                      alt=""
                    />
                  </div>
                </div>
                ...
                <div className="projects-detalis__content-text2">
                  ...
                  <ul>
                    <li>
                      <span className="icon-maps-and-flags"></span> It is a long
                      established fact
                    </li>
                    <li>
                      <span className="icon-maps-and-flags"></span> There are
                    ...
                    <li>
                      <span className="icon-maps-and-flags"></span> Many desktop
                      publishing packages
                    </li>
                  </ul>
                  <p className="text2">
                ...
                <div className="projects-detalis__content-text3">
                  ...
                  <ul>
                    <li>
                      <span className="icon-maps-and-flags"></span> Increasing
                    ...
                    <li>
                      <span className="icon-maps-and-flags"></span> The point of
                      using
                    </li>
                    <li>
                      <span className="icon-maps-and-flags"></span> Many desktop
            ...
            <div className="col-xl-4 col-lg-5">
              <div className="projects-detalis__sidebar">
                <div
                  className="projects-detalis__sidebar-single wow animated fadeInUp"
                  data-wow-delay="0.1s"
                >
                  <div className="title">
                  ...
                  <div className="projects-detalis__sidebar-project-info">
                    ...
                    <ul>
                      <li>
                        <span>Category</span>Office Cleaning
                      </li>
                      <li>
                        <span>Client</span>Unick Theme
                      </li>
                      <li>
                        <span>Start</span>04.04.2023
                      </li>
                      <li>
                        <span>End</span>01.06.2023
                      </li>
                      <li>
                        <span>Website</span>www.unicktheme.com
                      </li>
                      <li>
                        <span>Rating</span>
                ...
                <div
                  className="projects-detalis__sidebar-single pd-b22 wow animated fadeInUp"
                  data-wow-delay="0.3s"
                >
                    ...
                    <ul className="projects-detalis__sidebar-recent-post-list">
                      <li>
                        <div className="post-date">
                          <i className="far fa-clock"></i> 21 June, 2023{" "}
                        </div>
                        <h4>
                          <a href="#">
                ...
                <div
                  className="projects-detalis__sidebar-discount wow animated fadeInUp"
                  data-wow-delay="0.5s"
                >
                  <div className="img-box">
                    <img
                      src="/assets/images/resources/projects-detalis-img3.jpg"
                      alt=""
                    />
