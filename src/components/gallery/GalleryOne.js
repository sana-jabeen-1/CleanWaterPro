        ...
        <div className="container">
              ...
              <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div className="gallery-page__menu-box">
                  <ul className="project-filter clearfix post-filter has-dynamic-filters-counter">
                    ...
                    <li data-filter=".floor">
                      <span className="filter-text">Floor </span>
                    </li>
                    <li data-filter=".kitchen">
                      <span className="filter-text">Kitchen</span>
                    </li>
                    <li data-filter=".toilet">
                      <span className="filter-text">Toilet</span>
                    </li>
                    <li data-filter=".office">
          ...
          <div className="row filter-layout masonary-layout">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 filter-item house office">
              <div
                className="gallery-page__single wow fadeInUp"
                data-wow-delay="0ms"
